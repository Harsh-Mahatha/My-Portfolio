      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300">
            Let's collaborate and bring innovative web concepts to life!
          </p>
        </div>
          ...
          <CircuitTrailWrapper>
            <div className="bg-gray-800/30 p-8 h-full">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  <div className="block text-gray-300 text-sm mb-2">
                    Subject
                  </div>
                  <input
                    type="text"
                ...
                {status && (
                  <div
                    className={`text-center mt-2 font-semibold ${status.includes("success") ? "text-green-400" : "text-red-400"}`}
                  >
                    {status}
                  </div>
                )}
